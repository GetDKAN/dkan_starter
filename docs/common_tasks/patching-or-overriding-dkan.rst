...
1. Create the patch
   ...
   3. Get a diff of the PR
      ...
      1. Go to https://github.com/GetDKAN/MODULE/compare or https://github.com/GetDKAN/dkan/compare
    ...
    projects:
      dkan_datastore:
        ...
        download:
          ...
          tag: 7.x-1.12
        patch:
          1: "https://github.com/GetDKAN/dkan_datastore/compare/release-1-12...fix-filters-pw-1.diff"
