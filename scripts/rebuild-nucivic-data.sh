...
set -e
cd ../docroot
drush -y en data_disqus data_story nucivic_data publishing_workflow og_permissions_settings visualization_entity_choropleth_bundle visualization_entity_geojson_bundle
