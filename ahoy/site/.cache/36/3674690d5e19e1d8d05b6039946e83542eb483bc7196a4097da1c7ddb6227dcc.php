...
\$conf = ";
    ...
    {
        return new Twig_Source("", "config.php.twig", "/var/lib/jenkins/workspace/NuCivic Data - Sync DKAN and DKAN Starter PRs/dkan_starter/.ahoy/site/.templates/config.php.twig");
    }
}
